 ...
 */
        ...
        if (NBL_TEST_PROT_RSVD_FLAG(CurrNetBufferList, NPROT_ALLOCATED_NBL))
                {
                    //
                    //  This is a local copy.
                    //
        		//	DbgPrint("==>Free MDL\n");
                    pMdl = NET_BUFFER_FIRST_MDL(NET_BUFFER_LIST_FIRST_NB(CurrNetBufferList));
                    TotalLength = NET_BUFFER_DATA_LENGTH(NET_BUFFER_LIST_FIRST_NB(CurrNetBufferList));
