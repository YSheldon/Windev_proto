...
#define OPLK_ALLOC_MEM(_pVar, _Size)        \
...
#define OPLK_ALLOC_MEM(_pVar, _Size)        \
    NdisAllocateMemoryWithTag((PVOID *)(&_pVar), (_Size), MUX_TAG)
